            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                            ...
                            <div class="panel-body">
                                <input type="text" class="form-control" id="slug" data-slug-origin="name" name="slug" placeholder="{{ __('voyager::generic.slug') }}" value="@if(isset($dataTypeContent->slug)){{ $dataTypeContent->slug }}@endif">
                            </div>
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="panel-body">
                            <ul>
                                @foreach($allCategories as $category)
                                    <li><label><input type="checkbox" value="{{ $category->id }}" name="categories[]" {{ $categoriesForFeatured->contains($category) ? 'checked' : '' }}>{{ $category->name }}</label></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
